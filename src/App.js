...
import "./App.css";
import "./assets/images_favicon.png";
import "./assets/layout_assets_css_dynamic.css";
import "./assets/layout_assets_css_style.css";
import "./assets/layout_assets_plugins_bootstrap_css_bootstrap.min.css";
import "./assets/layout_assets_js_plugins_owl-carousel_owl.carousel.css";
// import "./assets/layout_assets_plugins_js_composer_js_composer.min.css";
    ...
    return (
      <div>
        ...
        <header className="ws-header-static">
          {/* <!-- Navbar --> */}
          <nav className="navbar ws-navbar">
